            ...
            <div class="card" id="admin-card">
                ...
                (function(){
                    ...
                    function sendLogoutBeacon(){
                        ...
                        try {
                            // Try sendBeacon with FormData
                            if (navigator && typeof navigator.sendBeacon === 'function'){
                                const fd = new FormData();
                                fd.append('_token', csrf);
                                return navigator.sendBeacon(logoutUrl, fd);
                            }
                        } catch (e) {
                            // ignore
                        }
                        try {
                            ...
                            fetch(logoutUrl, { method: 'POST', headers: { 'Accept': 'application/json' }, body: new URLSearchParams({'_token': csrf}), keepalive: true });
                            return true;
                        } catch (e) {
                            return false;
                        }
