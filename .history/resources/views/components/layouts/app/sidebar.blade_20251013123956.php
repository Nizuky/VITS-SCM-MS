        ...
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:dropdown class="hidden lg:block" position="bottom" align="start">
                ...
                <flux:menu class="w-[220px]">
                        ...
                        <flux:menu.radio.group>
                            @php
                                // Prefer a profile route if it exists; check common names across guards
                                $profileRoute = null;
                            ...
                            @if($profileRoute)
                                <flux:menu.item :href="route($profileRoute)" icon="cog" wire:navigate>{{ __('Settings') }}</flux:menu.item>
                            @else
                                <flux:menu.item href="#" icon="cog">{{ __('Settings') }}</flux:menu.item>
                            @endif
                        </flux:menu.radio.group>
                        ...
                        @php
                            // Determine logout route; prefer admin/logout when admin guard is active
                            $logoutRoute = null;
                            if (auth('admin')->check() && \Illuminate\Support\Facades\Route::has('admin.logout')) {
                                ...
                                $logoutRoute = route('superadmin.logout');
