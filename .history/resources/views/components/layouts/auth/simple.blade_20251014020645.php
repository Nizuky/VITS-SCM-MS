...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <head>
        ...
        <style>
            ...
            body { padding-top: var(--header-desktop-h); background-image: url('{{ asset('storage/vits_bg.png') }}'); background-repeat: no-repeat; background-position: center top; background-size: cover; background-attachment: fixed; }
