...
return [
    ...
    */
    ...
    | Livewire will serve its JavaScript from /livewire. However, if you want
    | to serve it from the public directory, set this to: null
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value is used when generating URLs to Livewire's JavaScript assets.
    | By default, Livewire will use the APP_URL environment variable value.
    |
    */
