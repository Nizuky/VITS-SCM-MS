<div id="record-status-page" class="page-content flex flex-col flex-1-dynamic">
          <p class="text-sm text-gray-600 mt-2 pb-6 text-center lg:text-left">&#9432 View the status of your submitted records, track approvals, and manage pending entries.</p>
