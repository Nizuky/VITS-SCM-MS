...
@endphp
    ...
    <script>
        ...
        function initSidebarResize() {
            ...
            try {
                const savedWidth = localStorage.getItem('scms_admin_sidebar_width');
                if (savedWidth) {
                    sidebar.style.width = savedWidth + 'px';
                    console.log('Admin - Restored sidebar width:', savedWidth);
                }
            } catch(e) {
                console.error('Admin - Error restoring sidebar width:', e);
            }
            ...
            document.addEventListener('mouseup', function() {
                if (isResizing) {
                    ...
                    try {
                        ...
                        localStorage.setItem('scms_admin_sidebar_width', currentWidth);
                        console.log('Admin - Saved sidebar width:', currentWidth);
                    } catch(e) {
                        console.error('Admin - Error saving sidebar width:', e);
                    }
                }
            });
        }
