...
<body class="min-h-screen bg-background-light">
    ...
    @include('partials.auto_logout_admin')
    <div class="flex p-4 gap-4 min-h-screen"> 
        <aside class="flex flex-col w-64 bg-white rounded-2xl p-4 shadow-sm">
            ...
            <ul class="menu p-0">
                ...
                <li>
                    <a class="py-3" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('admin-logout-form').submit();">
    ...
    <form id="admin-logout-form" action="{{ route('admin.logout') }}" method="POST" class="hidden">@csrf</form>
