        ...
        <div class="w-full flex justify-center mt-4">
            <div class="w-full max-w-[400px] px-4">
                ...
                <div id="student-exists" class="hidden bg-transparent rounded-xl p-4 shadow mx-auto" 
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="role-btn text-sm">
                        Yes — Login
                    </a>
                    <a href="<?php echo e(route('register')); ?>" class="role-btn text-sm">
                        No — Sign up
                    </a>
                    </div>
                </div>
                ...
                <div id="nonstudent-select" class="hidden bg-transparent rounded-xl p-4 shadow mx-auto" 
                    ...
                    <div class="flex flex-wrap gap-2 justify-center mt-2">
                    <button type="button" onclick="window.open('<?php echo e(route('admin.login')); ?>', '_blank')" class="role-btn text-sm">Admin</button>
                    <button type="button" onclick="window.open('<?php echo e(route('superadmin.login')); ?>', '_blank')" class="role-btn text-sm">Super Admin</button>
                    </div>
                </div>
                </div>
            </div>
