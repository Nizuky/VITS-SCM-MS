...
<tr>
    <td class="header" style="padding: 25px 0; text-align: center;">
        ...
        <a href="<?php echo new \Illuminate\Support\EncodedHtmlString($url); ?>" style="display: inline-block;">
            <img src="<?php echo new \Illuminate\Support\EncodedHtmlString($logoUrl); ?>" class="logo" alt="<?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?>" style="width:120px; height:auto; display:block; margin:0 auto;" />
        </a>
    </td>
</tr>
