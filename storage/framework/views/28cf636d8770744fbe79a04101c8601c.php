...
(function(){
  ...
  const logoutBeaconGet = <?php echo json_encode(route('admin.logout.beacon'), 15, 512) ?>;
  const logoutBeaconPost = <?php echo json_encode(route('admin.logout.beacon.post'), 15, 512) ?>;
  const loginUrl = <?php echo json_encode(route('admin.login'), 15, 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\Users\janar\Herd\scms\resources\views/partials/auto_logout_admin.blade.php ENDPATH**/ ?>