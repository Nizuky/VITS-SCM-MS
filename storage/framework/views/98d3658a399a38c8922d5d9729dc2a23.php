        ...
        <div class="modal-box w-11/12 max-w-2xl p-6 relative">
            ...
            <div class="space-y-4">
                ...
                <div class="modal-action">
                    ...
                    <button type="button" class="btn btn-warning text-white" onclick="openMessageModal()">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <dialog id="student_message_modal" class="modal">
        <div class="modal-box w-11/12 max-w-xl p-6 relative">
            ...
            <p id="message-student-name-display" class="text-sm text-gray-500 mb-6">Student Name</p>
            
            <div class="space-y-4">
                <!-- Message Type Toggle -->
                <div class="form-control w-full">
                    <label class="label">
                        <span class="label-text font-semibold">Message Type</span>
                    </label>
                    <div class="flex gap-2">
                        <button type="button" id="msg-type-message" class="btn btn-sm flex-1 btn-active" onclick="setMessageType('message')">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                            </svg>
                            Regular Message
                        </button>
                        <button type="button" id="msg-type-warning" class="btn btn-sm flex-1" onclick="setMessageType('warning')">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="regular-message-section">
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text font-semibold">Subject</span>
                        </label>
                        <input type="text" id="message-title" class="input input-bordered w-full" placeholder="Enter message subject..." maxlength="255">
                    </div>
                </div>

                <!-- Warning Level Selection (hidden by default) -->
                <div id="warning-level-section" class="hidden">
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text font-semibold">Warning Level</span>
                        </label>
                        <div class="grid grid-cols-3 gap-2">
                            <button type="button" id="warning-level-1" class="btn btn-outline border-2 flex flex-col py-3 h-auto warning-level-btn" onclick="selectWarningLevel(1)">
                                <div class="w-4 h-4 rounded-full bg-yellow-400 mb-1"></div>
                                <span class="text-xs font-bold">1st Warning</span>
                            </button>
                            <button type="button" id="warning-level-2" class="btn btn-outline border-2 flex flex-col py-3 h-auto warning-level-btn" onclick="selectWarningLevel(2)">
                                <div class="w-4 h-4 rounded-full bg-orange-500 mb-1"></div>
                                <span class="text-xs font-bold">2nd Warning</span>
                            </button>
                            <button type="button" id="warning-level-3" class="btn btn-outline border-2 flex flex-col py-3 h-auto warning-level-btn" onclick="selectWarningLevel(3)">
                                <div class="w-4 h-4 rounded-full bg-red-600 mb-1"></div>
                                <span class="text-xs font-bold">3rd Warning</span>
                            </button>
                        </div>
                        <p id="warning-level-description" class="text-xs text-gray-500 mt-2">Select a warning level above</p>
                    </div>
                    
                    <!-- Warning Reason Quick Select -->
                    <div class="form-control w-full mt-4">
                        <label class="label">
                            <span class="label-text font-semibold">Violation Reason (optional)</span>
                        </label>
                        <select id="warning-reason-select" class="select select-bordered w-full" onchange="applyWarningReason()">
                            <option value="">-- Select a reason or write custom --</option>
                            <option value="spam">Spamming submissions</option>
                            <option value="harmful">Sharing harmful or incorrect information</option>
                            <option value="naming">Inappropriate naming in submissions</option>
                            <option value="profanity">Use of profanity or inappropriate language</option>
                            <option value="fraud">Fraudulent activity or false information</option>
                ...
                <div class="form-control w-full">
                    ...
                    <textarea id="message-content" class="textarea textarea-bordered h-32 w-full" placeholder="Type your message here..." maxlength="2000"></textarea>
                    <label class="label">
                        <span class="label-text-alt text-gray-400"><span id="message-char-count">0</span>/2000 characters</span>
                    </label>
                </div>

                <!-- Third Warning Alert -->
                <div id="third-warning-alert" class="hidden bg-red-100 border-l-4 border-red-500 text-red-700 p-4 rounded-r-lg" role="alert">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm">This will flag the student's account for possible deletion.</p>
                        </div>
                    </div>
                </div>
                
                <div class="modal-action">
                    <button type="button" class="btn" onclick="document.getElementById('student_message_modal').close()">Cancel</button>
                    <button type="button" id="send-message-btn" class="btn bg-primary-purple hover:bg-primary-purple-hover text-white" onclick="sendStudentMessage()">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
