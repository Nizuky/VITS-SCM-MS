<div id="dashboard-page" class="page-content hidden flex-col flex-1-dynamic">
         <p class="text-sm text-gray-600 mt-2 pb-2 text-center lg:text-left">&#9432 View system summaries, pending requests, and quick actions for administration.</p>
    <!-- Inactive Account Warning Banner -->
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->status === 'inactive' && auth()->user()->inactive_at): ?>
        <?php
            ...
            <div class="px-4 py-3 space-y-3">
                ...
                <div class="bg-gray-900/50 rounded-lg p-3 border border-gray-700/50">
                    ...
                    <p class="text-orange-300 text-xs leading-relaxed">
                        Your account will be <strong class="text-orange-200">permanently deleted</strong> on <strong class="text-white"><?php echo e($deletionDate->format('F d, Y')); ?></strong> at <strong class="text-white"><?php echo e($deletionDate->format('g:i A')); ?></strong>
                    </p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-700/50 p-3 rounded-lg">
                        ...
                        <ul class="text-xs text-gray-400 space-y-1.5">
                            ...
                            <li class="flex justify-between"><span>Deactivated:</span> <span class="text-gray-300"><?php echo e($inactiveSince->format('M d, Y g:i A')); ?></span></li>
                            <li class="flex justify-between"><span>Deletion Date:</span> <span class="text-orange-400 font-medium"><?php echo e($deletionDate->format('M d, Y g:i A')); ?></span></li>
                        </ul>
                    </div>
