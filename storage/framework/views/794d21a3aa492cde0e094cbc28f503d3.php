        ...
        <div id="profile-view" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                <div>
                    ...
                    <p class="font-semibold text-lg text-text-header break-words"><?php echo e(auth()->user()->name); ?></p>
                </div>
                <div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="font-semibold text-lg text-text-header break-all"><?php echo e(auth()->user()->email); ?></p>
                </div>
                <div>
...
<?php /**PATH C:\Users\janar\Herd\scms\resources\views/partials/student/profile-page.blade.php ENDPATH**/ ?>