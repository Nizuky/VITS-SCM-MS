                            ...
                            <div class="ml-3 flex-1">
                                ...
                                <div class="mt-2 text-sm dark:text-red-400">
                                    ...
                                    <div class="bg-red-100 dark:bg-red-950/40 border border-red-200 dark:border-red-800 p-3 rounded-md mb-2">
                                        ...
                                        <p class="text-sm dark:text-red-300" style="color: #1a1a1a;">Your account will be permanently deleted on <strong><?php echo e($deletionDate->format('F d, Y \a\t g:i A')); ?></strong></p>
                                    </div>
