            ...
            <div class="card" id="admin-card">
                <div style="display:flex; align-items:center; justify-content:space-between; gap:12px; flex-wrap:wrap;">
                    <div>
                        ...
                        <p style="margin:0; color:#333;">Welcome, <strong><?php echo e(auth('admin')->user()->name ?? 'Admin'); ?></strong>. Use the controls below to manage administrative tasks.</p>
                    </div>
                    <div style="display:flex; gap:8px; align-items:center;">
                        <a href="<?php echo e(route('admin.logout')); ?>" onclick="event.preventDefault(); document.getElementById('admin-logout-form').submit();" class="role-btn">Logout</a>
                    </div>
                </div>
